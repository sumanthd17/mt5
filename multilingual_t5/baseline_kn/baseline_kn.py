...
# TODO(baseline_kn): Markdown description  that will appear on the catalog page.
_DESCRIPTION = """
...
# TODO(baseline_kn): BibTeX citation
_CITATION = """
"""


class BaselineKn(tfds.core.GeneratorBasedBuilder):
  """DatasetBuilder for baseline_kn dataset."""
  ...
  def _info(self) -> tfds.core.DatasetInfo:
    ...
    # TODO(baseline_kn): Specifies the tfds.core.DatasetInfo object
  ...
  def _split_generators(self, dl_manager: tfds.download.DownloadManager):
    ...
    path = dl_manager.download_and_extract('https://storage.googleapis.com/ai4b-anuvaad-nmt/ai4b-consolidated/en-kn.zip')
