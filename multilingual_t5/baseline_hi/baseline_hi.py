...
# TODO(baseline_hi): Markdown description  that will appear on the catalog page.
_DESCRIPTION = """
...
# TODO(baseline_hi): BibTeX citation
_CITATION = """
"""


class BaselineHi(tfds.core.GeneratorBasedBuilder):
  """DatasetBuilder for baseline_hi dataset."""
  ...
  def _info(self) -> tfds.core.DatasetInfo:
    ...
    # TODO(baseline_hi): Specifies the tfds.core.DatasetInfo object
  ...
  def _split_generators(self, dl_manager: tfds.download.DownloadManager):
    ...
    path = dl_manager.download_and_extract('https://storage.googleapis.com/ai4b-anuvaad-nmt/ai4b-consolidated/en-hi.zip')
  ...
  def _generate_examples(self, source, target):
    """Yields examples."""
    # TODO(baseline_hi): Yields (key, example) tuples from the dataset
