...
for SET in all anuvaad-legal wat2020-devtest wat2021-devtest sap-documentation-benchmark tico19 wmt-news
do 
    ...
    --gin_param="output_filename = '${BUCKET}/baselines/mT5/forward/mT5-${SET}-en-${LANG}'"\
