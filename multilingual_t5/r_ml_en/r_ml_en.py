...
# TODO(r_ml_en): Markdown description  that will appear on the catalog page.
_DESCRIPTION = """
...
# TODO(r_ml_en): BibTeX citation
_CITATION = """
"""


class RMlEn(tfds.core.GeneratorBasedBuilder):
  """DatasetBuilder for r_ml_en dataset."""
  ...
  def _info(self) -> tfds.core.DatasetInfo:
    ...
    # TODO(r_ml_en): Specifies the tfds.core.DatasetInfo object
  ...
  def _split_generators(self, dl_manager: tfds.download.DownloadManager):
    ...
    # TODO(r_ml_en): Downloads the data and defines the splits
    path = dl_manager.download_and_extract('https://storage.googleapis.com/ai4b-anuvaad-nmt/ai4b-models/mT5/ml/en-ml.zip')

    # TODO(r_ml_en): Returns the Dict[split names, Iterator[Key, Example]]
    return {
